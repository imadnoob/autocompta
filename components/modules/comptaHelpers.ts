...
export const PCM_META: Record<string, AccountMeta> = {
    ...
    '6145': { name: 'Frais postaux et frais de télécommunications', type: 'detail', nature: 'debit', lettrable: false, code_taxe: 'D20' },
    ...
    '71243': { name: 'Prestations de services', type: 'detail', nature: 'credit', lettrable: false, code_taxe: 'C20' },
